...
## Mitch's Additions  
* Added emitters for mouse events on drawn shapes. CRAN version does not emit events when clicked, meaning shiny cant interact with currently drawn layers. 
* TODO: Add maxExtent to leaflet.draw in JS to allow for restrictions on drawn objects.
